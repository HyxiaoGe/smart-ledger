      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.4fr)_minmax(320px,0.85fr)]">
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            <div className="flex w-full flex-col gap-2 rounded-2xl border border-slate-200 bg-white px-3 py-3 text-sm shadow-sm sm:inline-flex sm:w-auto sm:flex-none sm:flex-row sm:items-center sm:justify-start sm:rounded-full sm:py-2 dark:border-slate-700 dark:bg-slate-950">
