...
export default function QuickPage() {
  const { data: todayTransactions } = useAllDailyTransactionRowsQuery(new Date());
        ...
        <div className="mx-auto max-w-4xl px-4 py-4">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">快速记账</h1>
                <p className="text-sm text-gray-500 dark:text-gray-400">基于AI的智能快速记账，让记账更简单</p>
              </div>
            </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-orange-100 dark:bg-orange-900 text-orange-600 dark:text-orange-400 rounded-full flex items-center justify-center text-sm font-medium flex-shrink-0 mt-0.5">
                      1
                    </div>
                    <div>
                      <div className="font-medium text-gray-900 dark:text-gray-100">AI智能建议</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-gray-100">一键快速记账</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 dark:text-gray-100">自动智能分类</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">时间模式识别</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="text-gray-700 dark:text-gray-300">历史数据分析</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                    <span className="text-gray-700 dark:text-gray-300">消费行为学习</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                    <span className="text-gray-700 dark:text-gray-300">智能金额预测</span>
                  </div>
                </div>
