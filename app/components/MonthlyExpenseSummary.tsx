    ...
    return (
      <div className="space-y-6">
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8 text-center">
          <div className="text-lg font-semibold text-gray-800 mb-1">����֧������</div>
          <div className="text-sm text-gray-600">��¼��һ��֧���󼴿ɿ���ͳ��</div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs uppercase text-gray-500">����֧��</div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs uppercase text-gray-500">�¶�Ԥ�����</div>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-indigo-50 to-blue-100 rounded-xl p-6 shadow-lg border border-indigo-100">
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="text-xs text-indigo-600 uppercase">����֧��</div>
          ...
          <div className="space-y-2 text-sm text-indigo-700">
            <p>
              ƾ�ݣ�{items.length} �칲 {statistics.totalCount} ��֧��
            </p>
            <p>ƽ��ÿ�գ���{formatCurrency(statistics.dailyAverage)}</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-green-100 rounded-xl p-6 shadow-lg border border-emerald-100">
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="text-xs text-emerald-600 uppercase">�¶��ۼ�</div>
          ...
          <div className="space-y-2 text-sm text-emerald-700">
            <p>���{monthTotalCount} ��֧���Ѽ�¼</p>
            <p>Ԥ����ȣ�{statistics.monthProgress.toFixed(1)}%</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white/80 backdrop-blur rounded-xl border border-gray-100 p-5 shadow-sm">
          ...
          <p className="text-xs text-gray-500 mt-1">{statistics.maxTransactionDate || '���޼�¼'}</p>
          {statistics.maxTransactionNote ? (
            <p className="text-xs text-gray-500 mt-1">��ע��{statistics.maxTransactionNote}</p>
          ) : null}
        </div>
        ...
        <div className="bg-white/80 backdrop-blur rounded-xl border border-gray-100 p-5 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h4 className="font-semibold text-gray-800">ƽ������</h4>
          </div>
      ...
      {statistics.trend ? (
        <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border border-orange-100">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h4 className="font-semibold text-gray-800">�����ձȽ�</h4>
          </div>
          <p className="text-sm text-orange-700 leading-6">
            ����֧���仯 {statistics.trend.amountChange.toFixed(2)}��
            {statistics.trend.amountChangePercent.toFixed(1)}%���� ֧�������仯{' '}
            {statistics.trend.countChange} �ʡ�
          </p>
        </div>
      ) : null}
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 shadow-lg border border-purple-100">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-semibold text-gray-800">�¶�Ԥ�����</h4>
          </div>
      ...
      {dateRange ? <p className="text-xs text-muted-foreground">���ݷ�Χ��{dateRange}</p> : null}
    </div>
  );
}
